...
namespace nlopt {
	...
	const scgms::TSolver_Descriptor cobyla_desc = Describe_Non_Specialized_Solver(cobyla_id, dsCOBYLA);
}


const std::array<scgms::TSolver_Descriptor, 6> solver_descriptions = { nlopt::newuoa_desc, nlopt::bobyqa_desc, nlopt::simplex_desc, nlopt::subplex_desc, nlopt::praxis_desc, nlopt::cobyla_desc };
