...
class CRunge_Kutta_ODE_Solver_Adaptive : public CRunge_Kutta_ODE_Solver_Base<N>
{
	...
	public:
		explicit CRunge_Kutta_ODE_Solver_Adaptive(const TCoef_Matrix& rkMatrix, const TCoef_Array& weights, const TCoef_Array& weights_alt, const TCoef_Array& nodes, const double errThreshold)
			: CRunge_Kutta_ODE_Solver_Base<N>(rkMatrix, weights, nodes), mWeights_Alt(weights_alt), mError_Threshold(errThreshold)
		{
		}
