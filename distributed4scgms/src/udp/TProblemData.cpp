...
std::unique_ptr<CCommon_Problem> CSphere_Fitness::Clone_Internal() { return std::make_unique<CSphere_Fitness>(mProblem_Size); }
const char* CSphere_Fitness::Get_Name_Internal() { return typeid(this).name(); }


CRosenbrock_Fitness::CRosenbrock_Fitness(const size_t problem_size) : CCommon_Problem(problem_size) {	//aka De Jong 2
	mUpper_Bound_1D = 2.0;
...
std::unique_ptr<CCommon_Problem> CRosenbrock_Fitness::Clone_Internal() { return std::make_unique<CRosenbrock_Fitness>(mProblem_Size); }
const char* CRosenbrock_Fitness::Get_Name_Internal() { return typeid(this).name(); }


CAbsSum_Fitness::CAbsSum_Fitness(const size_t problem_size) : CCommon_Problem(problem_size) {	//aka De Jong 3
	mUpper_Bound_1D = 2.0;
}
...
std::unique_ptr<CCommon_Problem> CAbsSum_Fitness::Clone_Internal() { return std::make_unique<CAbsSum_Fitness>(mProblem_Size); }
...
std::unique_ptr<CCommon_Problem> CDeJong4_Fitness::Clone_Internal() { return std::make_unique<CDeJong4_Fitness>(mProblem_Size); }
const char* CDeJong4_Fitness::Get_Name_Internal() { return typeid(this).name(); }


CRastrigin_Fitness::CRastrigin_Fitness(const size_t problem_size) : CCommon_Problem(problem_size), mBase_Result(10.0*static_cast<double>(mProblem_Size)) { mUpper_Bound_1D = 5.12; };
...
std::unique_ptr<CCommon_Problem> CRastrigin_Fitness::Clone_Internal() { return std::make_unique<CRastrigin_Fitness>(mProblem_Size); }
...
std::unique_ptr<CCommon_Problem> CSchwefel_Fitness::Clone_Internal() { return std::make_unique<CSchwefel_Fitness>(mProblem_Size); }
const char* CSchwefel_Fitness::Get_Name_Internal() { return typeid(this).name(); }


CGriewank_Fitness::CGriewank_Fitness(const size_t problem_size) : CCommon_Problem(problem_size) { mUpper_Bound_1D = 600.0; };
...
std::unique_ptr<CCommon_Problem> CGriewank_Fitness::Clone_Internal() { return std::make_unique<CGriewank_Fitness>(mProblem_Size); }
const char* CGriewank_Fitness::Get_Name_Internal() { return typeid(this).name(); }


CStretchedSineV_Fitness::CStretchedSineV_Fitness(const size_t problem_size) : CCommon_Problem(problem_size) { mUpper_Bound_1D = 10.0; };	//Stretched V sine wave function
...
std::unique_ptr<CCommon_Problem> CStretchedSineV_Fitness::Clone_Internal() { return std::make_unique<CStretchedSineV_Fitness>(mProblem_Size); }
...
std::unique_ptr<CCommon_Problem> CMasters_Fitness::Clone_Internal() { return std::make_unique<CMasters_Fitness>(mProblem_Size); }
