...
class CPhysical_Activity_Detection_Model : public virtual CCommon_Calculated_Signal
{
	...
	public:
		...
		virtual HRESULT IfaceCalling Get_Default_Parameters(scgms::IModel_Parameter_Vector *parameters) const override final;
};
