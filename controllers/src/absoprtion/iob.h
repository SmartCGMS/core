...
class CInsulin_Absorption : public CCommon_Calculated_Signal {
	...
	public:
		CInsulin_Absorption(glucose::WTime_Segment segment, NInsulin_Calc_Mode mode);
...
class CInsulin_Absorption_Bilinear : public CInsulin_Absorption {
	...
	public:
		CInsulin_Absorption_Bilinear(glucose::WTime_Segment segment, NInsulin_Calc_Mode mode) : CInsulin_Absorption(segment, mode) {};
};
...
class CInsulin_Absorption_Exponential : public CInsulin_Absorption {
	...
	public:
		CInsulin_Absorption_Exponential(glucose::WTime_Segment segment, NInsulin_Calc_Mode mode) : CInsulin_Absorption(segment, mode) {};
};
