...
namespace basal_2_bolus {
	const size_t filter_param_count = model_param_count;
	const scgms::NParameter_Type filter_param_types[filter_param_count] = { scgms::NParameter_Type::ptDouble, scgms::NParameter_Type::ptRatTime };
	const wchar_t* filter_param_ui_names[filter_param_count] = { dsMinimum_Volume, dsPPeriod};
	const wchar_t* filter_param_config_names[filter_param_count] = { rsMinimum, rsPeriod };
	const wchar_t* filter_param_tooltips[filter_param_count] = { nullptr, nullptr};
