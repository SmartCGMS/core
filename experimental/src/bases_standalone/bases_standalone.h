...
class CBase_Functions_Standalone : public scgms::CBase_Filter, public scgms::IDiscrete_Model
{
	protected:
		bases_standalone::TParameters mParameters;
		...
		double mPhysical_Activity_Decaying_Index = 0;
	...
	protected:
		...
		void Store_IG(double time, double level);

	public:
		CBase_Functions_Standalone(scgms::IModel_Parameter_Vector* parameters, scgms::IFilter* output);
		virtual ~CBase_Functions_Standalone() = default;
