...
class CDaily_Routine_Model : public scgms::CBase_Filter, public scgms::IDiscrete_Model {
	protected:
		daily_routine::TParameters mParameters;
	...
	protected:
		...
		bool Emit_Estimated_Carb(double time, double value);

	public:
		CDaily_Routine_Model(scgms::IModel_Parameter_Vector* parameters, scgms::IFilter* output);
		virtual ~CDaily_Routine_Model() = default;
