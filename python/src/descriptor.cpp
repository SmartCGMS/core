...
namespace solver {
	const scgms::TSolver_Descriptor desc = Describe_Non_Specialized_Solver(id, dsPython_Solver);
}


const std::array<scgms::TSolver_Descriptor, 1> solver_descriptions = { solver::desc};
