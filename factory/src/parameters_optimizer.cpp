...
HRESULT IfaceCalling Optimize_Parameters(glucose::IFilter_Chain_Configuration *configuration, const size_t filter_index, const wchar_t *parameters_name, solver::TSolver_Setup &solver_setup) {
	return E_NOTIMPL;
}