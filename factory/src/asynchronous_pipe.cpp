...
#include "asynchronous_pipe.h"

#include "../../../common/rtl/manufactory.h"

HRESULT IfaceCalling create_filter_asynchronous_pipe(glucose::IFilter_Asynchronous_Pipe **pipe) {
	return Manufacture_Object<CFilter_Asynchronous_Pipe, glucose::IFilter_Asynchronous_Pipe>(pipe);
}

CFilter_Asynchronous_Pipe::CFilter_Asynchronous_Pipe() noexcept {
	mQueue.set_capacity(mDefault_Capacity);
}

CFilter_Asynchronous_Pipe::~CFilter_Asynchronous_Pipe() {
	//just empty to call all the dctors correctly
}

HRESULT CFilter_Asynchronous_Pipe::send(glucose::IDevice_Event* event) {
	if (event == nullptr)
		return E_INVALIDARG;
...
HRESULT CFilter_Asynchronous_Pipe::receive(glucose::IDevice_Event** event) {
...
HRESULT CFilter_Asynchronous_Pipe::abort() {
